...
const InPage = () => {
  ...
  return (
    <div className='flex flex-row items-center h-screen mx-auto'>
      ...
      {success && (<div><div className='p-4 ml-10 text-5xl font-bold text-green-400'>Success</div>
      <div className='p-8 ml-10 text-2xl font-bold text-green-400'>Kec Concert Welcomes you</div></div>
...
const OutPage = () => {
  ...
  return (
    <div className='flex flex-row items-center w-auto h-screen '>
      <div className='h-[40vh]'>
        <Scanner onScan={handleScanOut} allowMultiple={true} scanDelay={1000} />
      </div>
      {success && (<div><div className='ml-10 text-5xl font-bold text-green-400'>Success</div>
     <div className='ml-10 text-2xl font-bold text-green-400'>Thanks for Visiting </div></div>
    )}
      {failure && (<div><div className='ml-10 text-5xl font-bold text-red-800 bg-black'>Failure</div>
                       <div className='ml-10 text-2xl font-bold text-red-800 bg-black'>limit reached</div></div>
    )}
    </div>
  );
};
...
<div class="w-full max-w-sm bg-stone-900 border border-white-900 rounded-lg shadow bg-opacity-60"> <span class='flex flex-row justify-center text-3xl font-bold text-white mt-6'>Check-In</span>
    
        <img class="p-8 rounded-t-lg" src={img2} alt="product image" />
   
    <div class="px-5 pb-5">
   
            <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">Click here to validate your tickets for check-in</h5>
...
</svg> <span className='mx-6'>In </span> </button>
            </Link>  </div>
    </div>
</div>


<div class="w-full max-w-sm bg-stone-900 border border-white-900 rounded-lg shadow bg-opacity-60"> <span class='flex flex-row justify-center text-3xl font-bold text-white mt-6'>Check-Out</span>
 
        <img class="p-8 rounded-t-lg" src={img2} alt="product image" />
  
    <div class="px-5 pb-5">
    
            <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">Click here to validate you tickets for check-out</h5>
    ...
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 12.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Z"/>
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 3h-2l-.447-.894A2 2 0 0 0 12.764 1H7.236a2 2 0 0 0-1.789 1.106L5 3H3a2 2 0 0 0-2 2v11a1 1 0 0 0 1 1h16a1 1 0 0 0 1-1V5a2 2 0 0 0-2-2Z"/>
</svg>  <span className='mx-6'>Out </span>  </button>
            </Link>
            </div>
    </div>
    </div>
